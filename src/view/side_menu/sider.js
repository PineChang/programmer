...
class sider extends Component {
    constructor(props) {
        ...
        console.log('sider->navigator:' + _nav);
    }
                ...
                <View style={this.state.colorSet == "blue"?style.top:{
                    ...
                    <View style={style.left}>
                        ...
                        <View style={style.status}>
                            <Text
                                style={{color:"#2196F3",fontSize:8,alignItems:"center",justifyContent:"center"}}>正式会员</Text>
                        </View>
                        ...
                        <TouchableWithoutFeedback
                            ...
                            <View>
                                <Image resizeMode={"contain"} style={{width:180,opacity:this.state.bilibili?1:0}}
                                       source={require('./img/bili_drawerbg_logined.png')}/>
                                <Image resizeMode={"contain"}
                                       style={{width:180,marginTop:-278,opacity:this.state.bilibili?0:1}}
                                       source={require('./img/bili_drawerbg_not_logined.png')}/>
                            </View>
                        </TouchableWithoutFeedback>
                    </View>
                    <View style={style.notification}>
                        <TouchableOpacity onPress={this._switchTheme.bind(this)}>
                            <Image resizeMode={"contain"} style={{width:35,height:35}}
                                   source={require('./img/ic_navigation_header_notification.png')}/>
                        </TouchableOpacity>
                    </View>
                    <View style={style.mode}>
                        <TouchableOpacity onPress={this._switchTheme.bind(this)}>
                            <Image resizeMode={"contain"} style={{width:35}}
                                   source={require('./img/ic_switch_night.png')}/>
                        </TouchableOpacity>
                    </View>
                </View>
